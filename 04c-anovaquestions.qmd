# Framing the Question {#sec-anovaquestions}

{{< include _setupcode.qmd >}}

"Does exposure to various food types lead to different moral expectations?"  The primary question from the Organic Food Case Study (@sec-caseorganic) is about the relationship between two variables: the response (moral expectations; see @def-response) and the __factor__ of interest (food type).
